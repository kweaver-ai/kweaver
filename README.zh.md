...
**本文目录：** [📚 快速链接](#toc-quick-links) · [🎬 演示视频](#toc-demo) · [🚀 快速开始](#toc-quick-start) · [🛠️ KWeaver SDK](#toc-kweaver-sdk) · [🏗️ KWeaver Core](#toc-kweaver-core) · [📐 BKN Lang](#toc-bkn-lang) · [📊 基准测试](#toc-benchmarks) · [💬 交流社区](#toc-community) · [📬 支持与联系](#toc-support)
...
KWeaver 在开源上由两个**项目**组成：**kweaver-core**（本仓库）是在您的环境中部署的**服务端**平台；**kweaver-sdk** 是安装在本机、跳板机或 CI 中的**客户端** CLI 与多语言 SDK。下表为对照一览；本节后文说明客户端安装与使用，**服务端**能力见 [KWeaver Core](#toc-kweaver-core)。
...
**方式 3 — 用户名密码 HTTP 登录（本机全自动化，无需浏览器）**
