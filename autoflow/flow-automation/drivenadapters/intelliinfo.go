...
type Intelliinfo interface {
	...
	TransferData(ctx context.Context, data interface{}, apiVers int, userID string) (interface{}, error)
}
...
// TransferData 数据转换为智能信息数据
func (i *intelliinfo) TransferData(ctx context.Context, data interface{}, apiVers int, userID string) (interface{}, error) {
	switch apiVers {
	case V1:
		body := data.(*DataTransferReqV1)
		return i.TransferDataV1(ctx, body.RuleID, body.CallBack, userID, body.Data)
	case V2:
		body := data.(*DataTransferReqV2)
		return i.TransferDataV2(ctx, body, userID)
	default:
...
// TransferData 数据转换为智能信息数据
func (i *intelliinfo) TransferDataV1(ctx context.Context, ruleID, callback, userID string, data interface{}) (interface{}, error) {
...
func (i *intelliinfo) TransferDataV2(ctx context.Context, req *DataTransferReqV2, userID string) (interface{}, error) {
