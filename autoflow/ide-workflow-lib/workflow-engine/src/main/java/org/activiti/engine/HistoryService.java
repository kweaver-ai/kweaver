...
public interface HistoryService {
  ...
  /** Creates a new programmatic query to search for without case sensitive {@link HistoricProcessInstance}s. */
  HistoricProcessInstanceQuery createHistoricProcessInstanceQueryCI();
