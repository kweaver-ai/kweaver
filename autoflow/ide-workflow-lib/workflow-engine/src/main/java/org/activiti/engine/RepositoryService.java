...
public interface RepositoryService {
  ...
  //2014-11-20 by lw add starterOrg
  void addCandidateStarterOrg(String processDefinitionId, String orgId);
  void deleteCandidateStarterOrg(String processDefinitionId, String orgId);
}
