...
public interface TaskService {
  ...
  * for better performance.*/
  ...
  /** Add a new attachment to a task and/or a process instance and use an url as the content */
  Attachment createAttachment(String attachmentType, String taskId, String processInstanceId, String url, String userId); 
  ...
  Comment addComment(String taskId, String processInstanceId, String message, String displayArea);
  Comment addComment(String taskId, String processInstanceId, String type, String message, String displayArea);
  void complete(String taskId, String nextActDefId, Map<String, Object> variables);
  List<Comment> getTopProcessInstanceComments(String topProcessInstanceId) ;
  void setAssignee(String taskId, String userId, Boolean notUseTransferDscription);
}
