...
public class HistoricProcessInstanceQueryImpl extends AbstractVariableQueryImpl<HistoricProcessInstanceQuery, HistoricProcessInstance> implements HistoricProcessInstanceQuery {
  ...
  //by lw
  protected Integer procState;
  protected boolean ignoreCaseSensitive;
  ...
  public HistoricProcessInstanceQuery ignoreCaseSensitive() {
    this.ignoreCaseSensitive = true;
    return this;
  }
  ...
  protected void checkQueryOk() {
    ...
    if(includeProcessVariables && !ignoreCaseSensitive) {
    	this.orderBy(HistoricProcessInstanceQueryProperty.INCLUDED_VARIABLE_TIME).asc();
    }

    if(includeProcessVariables && ignoreCaseSensitive) {
    	this.orderBy(HistoricProcessInstanceQueryProperty.INCLUDED_VARIABLE_TIME_LOWER).asc();
    }
  ...
  //by lw
  public HistoricProcessInstanceQuery procState(Integer procState) {
