...
public class HistoricTaskInstanceQueryImpl extends AbstractVariableQueryImpl<HistoricTaskInstanceQuery, HistoricTaskInstance> implements HistoricTaskInstanceQuery {
  ...
  public HistoricTaskInstanceQuery taskDeleteReasonIn(List<String> taskDeleteReasons) {
    if (inOrStatement) {
      this.currentOrQueryObject.taskDeleteReasons = taskDeleteReasons;
    } else {
  ...
  public String getInvolvedUser() {
	...
	// by lw
	@Override
	public HistoricTaskInstanceQuery includeTaskComments() {
		this.includeTaskComments = true;
		return this;
	}

  // by siyu.chen 2023/7/25
  public List<String> getTaskDeleteReasons() {
    return taskDeleteReasons;
  }
}
