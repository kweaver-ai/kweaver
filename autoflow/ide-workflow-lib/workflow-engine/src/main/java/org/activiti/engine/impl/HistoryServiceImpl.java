...
public class HistoryServiceImpl extends ServiceImpl implements HistoryService {
  ...
  public HistoricProcessInstanceQuery createHistoricProcessInstanceQueryCI() {
    return new HistoricProcessInstanceQueryImpl(commandExecutor).ignoreCaseSensitive();
  }
