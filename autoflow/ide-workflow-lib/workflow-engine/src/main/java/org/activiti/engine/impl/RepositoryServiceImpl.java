...
public class RepositoryServiceImpl extends ServiceImpl implements RepositoryService {
	...
	public void deleteCandidateStarterGroup(String processDefinitionId, String groupId) {
		commandExecutor
				.execute(new DeleteIdentityLinkForProcessDefinitionCmd(processDefinitionId, null, groupId, null));
	}
	...
	public void addCandidateStarterOrg(String processDefinitionId, String orgId) {
		commandExecutor.execute(new AddIdentityLinkForProcessDefinitionCmd(processDefinitionId, null, null, orgId));
	}

	public void deleteCandidateStarterOrg(String processDefinitionId, String orgId) {
		commandExecutor.execute(new DeleteIdentityLinkForProcessDefinitionCmd(processDefinitionId, null, null, orgId));
	}
}
