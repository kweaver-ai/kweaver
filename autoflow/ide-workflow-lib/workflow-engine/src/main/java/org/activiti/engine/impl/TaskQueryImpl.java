...
//2014-1-28 by lw
  ...
  protected boolean includeTaskComments = false;
  // 2023/7/25 by siyu.chen
  protected List<String> taskDeleteReasons;
  ...
  public String getNameLikeIgnoreCase() {
	...
	//2014-1-28 by lw
	  @Override
	  public TaskQuery procTitle(String procTitle) {
	  	 this.procTitle = procTitle;
	  	    return this;
	  }

	@Override
	public TaskQuery preTaskDefKey(String preTaskDefKey) {
		this.preTaskDefKey=preTaskDefKey;
		 return this;
	}

	@Override
	public TaskQuery preTaskDefName(String preTaskDefName) {
		this.preTaskDefName=preTaskDefName;
		 return this;
	}

	@Override
	public TaskQuery preTaskId(String preTaskId) {
	...
	//by lw
	@Override
	public TaskQuery includeTaskComments() {
		 this.includeTaskComments = true;
		    return this;
	}

	public TaskQueryImpl taskAssigneeUserId(String assigneeUserId) {
		if (assigneeUserId == null) {
			throw new ActivitiIllegalArgumentException("Assignee UserId is null");
		}
		if (orActive) {
			currentOrQueryObject.assigneeUserId = assigneeUserId;
		} else {
  ...
  public TaskQuery taskDeleteReasonIn(List<String> taskDeleteReasons) {
    if(orActive) {
      currentOrQueryObject.taskDeleteReasons = taskDeleteReasons;
    } else {
      this.taskDeleteReasons = taskDeleteReasons;
    }
    return this;
  }
}
