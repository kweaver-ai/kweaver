...
public class TaskServiceImpl extends ServiceImpl implements TaskService {
	...
	public void setAssignee(String taskId, String userId, Boolean notUseTransferDscription) {
		commandExecutor.execute(new AddIdentityLinkCmd(taskId, userId, null, IdentityLinkType.ASSIGNEE, notUseTransferDscription));
	}
	...
	public Attachment createAttachment(String attachmentType, String taskId, String processInstanceId, String url, String userId) {
		return commandExecutor.execute(new CreateAttachmentCmd(attachmentType, taskId, processInstanceId, url, userId));
	}
	...
	public Comment addComment(String taskId, String processInstance, String message, String displayArea) {
		return commandExecutor.execute(new AddCommentCmd(taskId, processInstance, message, displayArea));
	}

	public Comment addComment(String taskId, String processInstance, String type, String message, String displayArea) {
		return commandExecutor.execute(new AddCommentCmd(taskId, processInstance, type, message, displayArea));
	}

	public void deleteComments(String taskId, String processInstanceId, String type) {
		commandExecutor.execute(new DeleteCommentCmd(taskId, processInstanceId, type));
	}

	public void deleteTaskAndExecution(String taskId) {
		commandExecutor.execute(new DeleteTaskCmd(taskId, true));
	}

	public void complete(String taskId, String nextActDefId, Map<String, Object> variables) {
		commandExecutor.execute(new CompleteTaskCmd(taskId, nextActDefId, variables));
	}

	@Override
	public List<Comment> getTopProcessInstanceComments(String topProcessInstanceId) {
		 return commandExecutor.execute(new GetProcessInstanceCommentsCmd("",topProcessInstanceId,""));
	}
}
