...
//by lw
	/*
	 * public MailActivityBehavior createMailActivityBehavior(ServiceTask
	 * serviceTask) { return createMailActivityBehavior(serviceTask.getId(),
	 ...
	 * List<FieldExtension> fields) { List<FieldDeclaration> fieldDeclarations =
	 * createFieldDeclarations(fields); return (MailActivityBehavior)
	 * ClassDelegate.defaultInstantiateDelegate(MailActivityBehavior.class,
	 * fieldDeclarations); }
	 */
