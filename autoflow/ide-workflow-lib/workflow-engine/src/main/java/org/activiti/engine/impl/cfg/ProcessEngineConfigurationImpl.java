...
public abstract class ProcessEngineConfigurationImpl extends ProcessEngineConfiguration {  
  ...
  */
  ...
  //by lw
  protected TaskListener globalTaskAssigneeListener;
  protected List<TaskListener> globalTaskCreateListeners; 
  protected List<TaskListener> globalTaskCompleteListeners;
  ...
  public ObjectMapper getObjectMapper() {
	...
	public TaskListener getGlobalTaskAssigneeListener() {
		return globalTaskAssigneeListener;
	}

	public void setGlobalTaskAssigneeListener(
			TaskListener globalTaskAssigneeListener) {
		this.globalTaskAssigneeListener = globalTaskAssigneeListener;
	}

	public List<TaskListener> getGlobalTaskCreateListeners() {
		return globalTaskCreateListeners;
	}

	public void setGlobalTaskCreateListeners(
			List<TaskListener> globalTaskCreateListeners) {
		this.globalTaskCreateListeners = globalTaskCreateListeners;
	}

	public List<TaskListener> getGlobalTaskCompleteListeners() {
		return globalTaskCompleteListeners;
	}

	public void setGlobalTaskCompleteListeners(
			List<TaskListener> globalTaskCompleteListeners) {
		this.globalTaskCompleteListeners = globalTaskCompleteListeners;
	}
