 ...
 * @author Tom Baeyens
 */
public class AddCommentByExtendCmd implements Command<Comment>{
  ...
  public AddCommentByExtendCmd(String taskId, String processInstanceId, String message,String displayArea) {
    this.taskId = taskId;
  ...
  public AddCommentByExtendCmd(String taskId, String processInstanceId, String type, String message,String displayArea) {
    this.taskId = taskId;
    this.processInstanceId = processInstanceId;
    this.type = type;
    this.message = message;
  ...
  public Comment execute(CommandContext commandContext) {
    ...
    if (processInstanceId != null) {
      ...
      topProcessInstanceId=execution.getTopProcessInstanceId();
    }
    ...
    comment.setDisplayArea(displayArea);
    comment.setProcessInstanceId(processInstanceId);
    comment.setAction(Event.ACTION_ADD_COMMENT);
    comment.setTopProcessInstanceId(topProcessInstanceId);
