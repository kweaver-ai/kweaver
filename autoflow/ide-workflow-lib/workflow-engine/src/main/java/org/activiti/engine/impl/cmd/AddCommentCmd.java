...
public class AddCommentCmd implements Command<Comment>{
  ...
  public AddCommentCmd(String taskId, String processInstanceId, String message,String displayArea) {
	    this.taskId = taskId;
	  ...
	  public AddCommentCmd(String taskId, String processInstanceId, String type, String message,String displayArea) {
	    this.taskId = taskId;
	    this.processInstanceId = processInstanceId;
	    this.type = type;
	    this.message = message;
