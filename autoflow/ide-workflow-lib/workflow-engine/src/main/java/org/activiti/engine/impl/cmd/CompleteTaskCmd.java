...
public class CompleteTaskCmd extends NeedsActiveTaskCmd<Void> {
	...
	public CompleteTaskCmd(String taskId, String nextActDefId, Map<String, Object> variables) {
		super(taskId);
		this.variables = variables;
		this.nextActDefId = nextActDefId;
	}
	...
	protected Void execute(CommandContext commandContext, TaskEntity task) {
		// by lw
		commandContext.addAttribute("nextActDefId", nextActDefId);
		if (variables != null) {
			if (localScope) {
