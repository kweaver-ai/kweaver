...
public class CreateAttachmentCmd implements Command<Attachment> {  
  ...
  protected Boolean enableComment;
  ...
  public CreateAttachmentCmd(String attachmentType, String taskId, String processInstanceId, String url, String userId) {
    this.attachmentType = attachmentType;
    this.taskId = taskId;
    this.processInstanceId = processInstanceId;
    this.url = url;
  ...
  public Attachment execute(CommandContext commandContext) {
    ...
    attachment.setUserId(this.userId != null? this.userId : Authentication.getAuthenticatedUserId());
