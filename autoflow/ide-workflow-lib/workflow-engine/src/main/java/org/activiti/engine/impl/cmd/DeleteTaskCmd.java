...
public class DeleteTaskCmd implements Command<Void>, Serializable {
	...
	boolean isDelExcution=false;
	// by lw
	public DeleteTaskCmd(String taskId, boolean isDelExcution) {
		this.taskId = taskId;
		this.isDelExcution = isDelExcution;
	}
	...
	public Void execute(CommandContext commandContext) {
		if (taskId != null) {
			if (isDelExcution) {
				commandContext.getTaskEntityManager().deleteTaskAndExecution(taskId, "", true);
			} else {
