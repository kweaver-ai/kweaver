...
public class StartProcessInstanceCmd<T> implements Command<ProcessInstance>, Serializable {
  ...
  public ProcessInstance execute(CommandContext commandContext) {
	  try {
		  //by lw
			  commandContext.addAttribute("startNextActDefId", WfEngineUtils.getWfprocessInputModel(variables).getWf_curActDefId());
		    }catch(Exception e) {
    ...
    //2014-1-28 by lw
    ExecutionEntity processInstance = processDefinition.createProcessInstance(businessKey, null,variables);
