...
public interface HistoryManager extends Session {
	...
	/**
     * @description Record a process-instance auto ended. Updates the historic process instance if activity history is enabled.
     * @author ouandyang
     * @updateTime 2022/3/3
     */
	public abstract void recordProcessInstanceAutoEnd(String processInstanceId,
			String deleteReason, String activityId);
	 ...
	 */
	public abstract void recordTaskEnd(ExecutionEntity execution,String taskId, String deleteReason);
	...
	/**
	 * by lw start Record the creation of a task, if audit history is
	 * enabled.
	 */
	public abstract void recordActivityEndExtend(HistoricTaskInstanceEntity historicTaskInstance,String activityType) ;

	public abstract HistoricTaskInstanceEntity recordTaskEndExtend(ActivityExecution execution);

	public abstract void recordTaskUpdate(TaskEntity taskEntity);

	public abstract void recordProcessInstanceCancel(String processInstanceId,
			String cancelReason, String activityId);
	public abstract void recordSubProcessActivityStart(ExecutionEntity executionEntity,ActivityImpl startAct);
	/**
	 * Record task assignee change, if audit history is enabled. by lw add
	 * assigneeUserName params
	 */
	public abstract void recordTaskAssigneeChange(TaskEntity task);
