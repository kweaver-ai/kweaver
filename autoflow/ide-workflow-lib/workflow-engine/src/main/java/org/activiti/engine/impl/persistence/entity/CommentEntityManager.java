...
//by lw
  public void addCommentNotValidate(String taskId, String processInstanceId,String topProcessInstanceId, String message,String displayArea) {
    ...
    getDbSqlSession().insert(comment);
  }
  //by lw
  @SuppressWarnings("unchecked")
  public List<Comment> findCommentsByTopProcessInstanceId(String topProcessInstanceId) {
    checkHistoryEnabled();
    return getDbSqlSession().selectList("selectCommentsByTopProcessInstanceId", topProcessInstanceId);
  }
}
