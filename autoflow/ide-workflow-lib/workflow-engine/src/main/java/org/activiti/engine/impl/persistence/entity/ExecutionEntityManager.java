...
public class ExecutionEntityManager extends AbstractManager {
  ...
  //by lw
  public List<ExecutionEntity> findAllExecution(ProcessInstanceQueryImpl executionQuery) {
	 return getDbSqlSession().selectList("selectAllExecution", executionQuery);
  }
  
  public ExecutionEntity getParentExecution(ProcessInstanceQueryImpl executionQuery) {
	 return (ExecutionEntity) getDbSqlSession().selectOne("getParentExecution", executionQuery);
  }
}
