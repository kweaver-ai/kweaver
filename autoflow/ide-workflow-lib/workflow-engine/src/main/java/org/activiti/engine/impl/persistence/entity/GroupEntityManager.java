...
public class GroupEntityManager extends AbstractManager implements GroupIdentityManager {
	...
	public void deleteGroup(String groupId) {
		...
		if (group != null) {
			if (getProcessEngineConfiguration().getEventDispatcher().isEnabled()) {
				getProcessEngineConfiguration().getEventDispatcher().dispatchEvent(ActivitiEventBuilder
						.createMembershipEvent(ActivitiEventType.MEMBERSHIPS_DELETED, groupId, null));
			}
	...
	@SuppressWarnings("unchecked") // by lw
	public List<Group> findGroupsByUser(String userId, String appId) {
