...
//2014-1-27 by lw
	...
	protected String preActId;
	protected String preActName;
	protected String preActInstId;
	...
	public String getPreActId() {
		return preActId;
	}

	public void setPreActId(String preActId) {
		this.preActId = preActId;
	}

	public String getPreActName() {
		return preActName;
	}

	public void setPreActName(String preActName) {
		this.preActName = preActName;
	}

	public String getPreActInstId() {
		return preActInstId;
	}

	public void setPreActInstId(String preActInstId) {
		this.preActInstId = preActInstId;
	}
