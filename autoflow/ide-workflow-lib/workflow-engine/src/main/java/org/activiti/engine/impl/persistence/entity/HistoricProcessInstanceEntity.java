...
public class HistoricProcessInstanceEntity extends HistoricScopeInstanceEntity
		implements HistoricProcessInstance, BulkDeleteable {
...
//2014-1-28 by lw
	...
	public HistoricProcessInstanceEntity(ExecutionEntity processInstance) {
		...
		// 2014-1-28 by lw
		WfEngineUtils.buildExtHistoricProcessInstanceEntity(this, processInstance);
	}
	...
	public Object getPersistentState() {
		...
		// by lw
		persistentState.put("procState", this.procState);
