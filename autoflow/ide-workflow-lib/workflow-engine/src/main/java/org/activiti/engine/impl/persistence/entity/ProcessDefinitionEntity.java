...
public class ProcessDefinitionEntity extends ProcessDefinitionImpl
	...
	// by lw
	public ExecutionEntity createProcessInstance(ExecutionEntity processInstance, String businessKey,
		...
		// Reset the process instance in order to have the db-generated process instance
		// id available
		...
		if (dataObjectVars != null) {
			...
			WfEngineUtils.buildExtExecution(variables, processInstance);// by lw
		}
	...
	// by lw
	public ExecutionEntity createProcessInstance(String businessKey, ActivityImpl initial, Map variables) {
		...
		if (variables != null) {
			...
			WfEngineUtils.buildExtExecution(variables, processInstance);
		}
		createProcessInstance(processInstance, businessKey, initial);
		return processInstance;
	}
...
//by lw extends
	...
	// by lw
	public IdentityLinkEntity addIdentityLink(String userId, String groupId, String orgId) {
		IdentityLinkEntity identityLinkEntity = new IdentityLinkEntity();
		getIdentityLinks().add(identityLinkEntity);
		identityLinkEntity.setProcessDef(this);
		identityLinkEntity.setUserId(userId);
		identityLinkEntity.setGroupId(groupId);
		identityLinkEntity.setOrgId(orgId);
		identityLinkEntity.setType(IdentityLinkType.CANDIDATE);
		identityLinkEntity.insert();
		return identityLinkEntity;
	}

//by lw delete starterOrg
	public void deleteIdentityLink(String userId, String groupId, String orgId) {
		List<IdentityLinkEntity> identityLinks = Context.getCommandContext().getIdentityLinkEntityManager()
				.findIdentityLinkByProcessDefinitionUserAndGroup(id, userId, groupId, orgId);
