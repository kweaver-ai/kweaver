...
public interface SuspensionState {
  ...
  SuspensionState CANCELED = new SuspensionStateImpl(3, "canceled");
  SuspensionState HIDE = new SuspensionStateImpl(4, "hide");
  SuspensionState FINISH = new SuspensionStateImpl(5, "finish");
  SuspensionState AUTO_REJECT = new SuspensionStateImpl(6, "autoReject");
