...
public class VariableInstanceEntityManager extends AbstractManager {
  ...
  //by lw
  @SuppressWarnings("unchecked")
  public VariableInstanceEntity findVariableInstancesByKey(String procInstId,String key) {
	  Map<String,Object> parameterMap=new HashMap<String,Object>();
      parameterMap.put("procInstId", procInstId);
      parameterMap.put("key", key);
	  VariableInstanceEntity var=(VariableInstanceEntity) getDbSqlSession().selectOne("selectVariablesByKey", parameterMap);
	  return var;
  }
}
