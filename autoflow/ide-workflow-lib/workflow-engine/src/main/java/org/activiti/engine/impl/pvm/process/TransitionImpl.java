...
public class TransitionImpl extends ProcessElementImpl implements PvmTransition {
  ...
  //by lw
  protected List<ExpandProperty> expandPropertys;
  ...
  public void setDestination(ActivityImpl destination) {
	...
	// by lw
	public void setDestinationByExtend(ActivityImpl destination) {
		this.destination = destination;
	}
  ...
  @SuppressWarnings("unchecked")
	public List<ExpandProperty> getExpandPropertys() {
		if (expandPropertys == null) {
			return Collections.EMPTY_LIST;
		}
		return expandPropertys;
	}

	public void setExpandPropertys(List<ExpandProperty> expandPropertys) {
		this.expandPropertys = expandPropertys;
	}
}
