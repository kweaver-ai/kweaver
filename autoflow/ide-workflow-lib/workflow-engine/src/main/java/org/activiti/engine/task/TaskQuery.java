...
public interface TaskQuery extends TaskInfoQuery<TaskQuery, Task> {
   ...
   *  by lw
   */
  TaskQuery procTitle(String procTitle);
  TaskQuery taskAssigneeUserId(String assigneeUserId);
  TaskQuery preTaskDefKey(String preTaskDefKey);
  TaskQuery preTaskDefName(String preTaskDefName);
  TaskQuery preTaskId(String preTaskId);
}
