...
class AgentTool(Tool):
    def __init__(self, agent_skill: AgentSkillVo):
    ...
    async def arun_stream(self, **kwargs):
        ...
        url = "http://{HOST_AGENT_EXECUTOR}:{PORT_AGENT_EXECUTOR}/api/agent-executor/v1/agent/run".format(
        ...
        body = {
            "id": self.agent_info.get("id", ""),
            "config": self.agent_info.get("config", {}),
            "input": tool_input,
