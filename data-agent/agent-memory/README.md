...
# 设置依赖服务调用地址
export RERANK_URL=http://XXX:9898/api/private/mf-model-api/v1/small-model/reranker
export OPENSEARCH_HOST=XXX
export EMBEDDING_MODEL_BASE_URL=http://XXX:9898/api/private/mf-model-api/v1/small-model
export LLM_BASE_URL=http://XXX:9898/api/private/mf-model-api/v1
