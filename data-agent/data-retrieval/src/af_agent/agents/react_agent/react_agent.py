...
from af_agent.tools import ToolMultipleResult, LogResult
...
from af_agent.agents.base import BaseAgent
from af_agent.agents.react_agent.base import AfAgent, AfSailorAgentExecutor
from af_agent.callbacks.agent_callbacks import AfAgentActionCallbackHandler
from af_agent.logs.logger import logger
from af_agent.parsers.agent_parser import AfAgentParserErrorHandler
# from af_agent.prompts.agent_prompts.react_agent_prompt import (
#     SUFFIX,
#     FORMAT_INSTRUCTIONS,
#     PREFIX,
...
from af_agent.tools import ToolResult, ToolName, LogResult, ToolMultipleResult
from af_agent.tools import construct_final_answer, async_construct_final_answer
from af_agent.tools.toolkits import InstructionBookInsideToolkit
from af_agent.tools.base import is_tool_message
...
from af_agent.utils.model_types import ModelType4Prompt, get_standard_model_type
from af_agent.utils.llm import deal_think_tags
...
class ReactAgent(BaseAgent):
    af_agent_executor_with_chat_history: AfSailorAgentExecutor | None = None
    # af_agent_executor_with_chat_history = None
