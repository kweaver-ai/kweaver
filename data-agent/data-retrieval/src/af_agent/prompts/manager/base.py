...
PROMPT_MAPPINGS = [
    # Agent Prompts
    {
        "module": "af_agent.prompts.agent_prompts.react_agent_prompt.langchain",
        "class": "LangchainReactAgentPrompt"
    },
    {
        "module": "af_agent.prompts.agent_prompts.react_agent_prompt.default",
        "class": "DefaultReactAgentPrompt"
    },
    {
        "module": "af_agent.prompts.agent_prompts.react_agent_prompt.deepseek_r1",
        "class": "DeepSeekR1ReactAgentPrompt"
    },
    # Tool Use
    {
        "module": "af_agent.prompts.agent_prompts.tool_use_prompt",
        "class": "ToolUsePrompt"
    },
    ...
    {
        "module": "af_agent.prompts.tools_prompts.text2sql_prompt.text2sql",
        "class": "Text2SQLPrompt"
    },
    {
        "module": "af_agent.prompts.tools_prompts.text2metric_prompt.unified",
        "class": "Text2MetricPrompt"
    },
    {
        "module": "af_agent.prompts.tools_prompts.datasource_filter_prompt",
        "class": "DataSourceFilterPrompt"
    },
    {
        "module": "af_agent.prompts.tools_prompts.text2dip_metric_prompt",
