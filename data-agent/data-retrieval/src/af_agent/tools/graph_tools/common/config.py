...
class ConfigClass:
    ...
    if DEBUG:
        ...
        REDISREADPORT = 6379
        REDISREADUSER = "root"
        REDISREADPASS = "eisoo.com123"
        # REDISREADPASS = 'Driver@13'
        REDISWRITEHOST = DIPHOST
        REDISWRITEPORT = 6379
        REDISWRITEUSER = "root"
        REDISWRITEPASS = "eisoo.com123"
        # REDISWRITEPASS = 'Driver@13'
        REDISHOST = DIPHOST
        REDISPORT = 6379
        REDISUSER = "root"
        REDISPASS = "eisoo.com123"
        # REDISPASS = 'Driver@13'
        ...
        GRAPHDB_READ_ONLY_PASSWORD = "eisoo.com123"
