...
CREATE TABLE IF NOT EXISTS `metadata` (                         -- 此表保存文档元数据
    `parentId` char(40) NOT NULL,                               -- 父对象id
    `objectId` char(40) NOT NULL,                               -- 对象id
    `name` varchar(2048) NOT NULL,                              -- 对象名
    `basic_attr` bigint(20) DEFAULT '0',                        -- 基本属性, 1为目录, 2为文件, 4为版本
    `custom_attr` bigint(20) DEFAULT '0',                       -- 自定义属性
    `extended_attr` varchar(4096) DEFAULT NULL,                 -- 拓展属性
    `ossId` char(40) DEFAULT NULL,                              -- 文件版本所属的存储id
    `creatorId` char(40) DEFAULT NULL,                          -- 创建者id
    `creatorName` varchar(150) NOT NULL DEFAULT '',             -- 创建者名称
    `creatorType` tinyint(4) DEFAULT '0',                       -- 创建者类型
    `create_time` bigint(20) DEFAULT '0',                       -- 创建时间
    `delete_time` bigint(20) DEFAULT '0',                       -- 删除时间
    `archive` bigint(20) DEFAULT '0',                           -- 归档标识
    `csf_level` smallint(6) DEFAULT '5',                        -- 密级
    `custom_metadata` blob,                                     -- 自定义元数据
    PRIMARY KEY (`objectId`),
    KEY `parentId_Index` (`parentId`) USING HASH,
    KEY `name_Index` (`name`(128)) USING HASH,
    KEY `idx_creatorId` (`creatorId`) USING HASH,
    KEY `idx_basic_attr_and_custom_attr` (`basic_attr`,`custom_attr`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `metadata_0` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
  `basic_attr` bigint(20) NOT NULL COMMENT '基本属性, 0:文档库 1:目录 2:文件 4:版本',
  `custom_attr` bigint(20) NOT NULL COMMENT '自定义属性，目前代表对象的状态，如创建中、病毒和被删除(回收站)等',
  `creator_id` binary(16) NOT NULL COMMENT '创建者id',
  `creator_name` varchar(150) NOT NULL COMMENT '创建者名称',
  `creator_type` tinyint(4) unsigned NOT NULL COMMENT '创建者类型',
  `create_time` bigint(20) NOT NULL COMMENT '创建时间，微秒精度',
  `delete_time` bigint(20) NOT NULL COMMENT '删除时间，微秒精度，从二级回收站是物理删除，故该状态只在某些情况下有值',
  `csf_level` tinyint(4) unsigned NOT NULL COMMENT '密级',
  `custom_metadata` text NOT NULL COMMENT '客户端使用的扩展元数据，JSON格式，对应以前的 blob',
  `system_data` text NOT NULL COMMENT '系统内部使用的扩展数据，JSON格式，目前用来记录回收站对象的还原路径信息',
  `status` bigint(20) NOT NULL COMMENT '状态，目前仅用在版本对象，0: 不完整版本 1：上传处理待删除 2：完整版本',
  `size` bigint(20) NOT NULL COMMENT '对象大小，文件 size 是最新版本大小，版本 size 就是其大小，目录和文档库的 size 是 -1',
  `storage` varchar(2048) NOT NULL COMMENT '对象存储信息，仅适用于版本对象，格式为 ossId/docLibId/versionId',
  PRIMARY KEY (`id`),
  ...
  KEY `idx_basic_attr_and_custom_attr` (`basic_attr`,`custom_attr`),
  KEY `idx_basic_attr_status_create_time` (`basic_attr`,`status`, `create_time`)
) ENGINE=InnoDB  COMMENT='元数据表';

CREATE TABLE IF NOT EXISTS `metadata_1` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_3` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_4` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_5` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_6` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_7` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_8` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_9` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_10` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_11` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_12` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_13` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_14` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_15` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_16` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_17` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_18` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_19` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_20` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_21` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_22` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_23` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_24` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_25` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_26` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_27` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_28` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_29` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_30` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_31` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `object_id` binary(16) NOT NULL COMMENT '对象ID',
  `parent_id` binary(16) NOT NULL COMMENT '父对象ID',
  `object_name` varchar(2048) NOT NULL COMMENT '对象名称',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_0` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
  PRIMARY KEY (`id`),
  KEY `idx_object_id` (`object_id`),
  KEY `idx_ancestor_distance_object_id` (`ancestor_id`,`distance`,`object_id`)
) ENGINE=InnoDB COMMENT='元数据路径表';

CREATE TABLE IF NOT EXISTS `metadata_closure_1` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_2` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_3` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_4` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_5` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_6` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_7` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_8` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_9` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_10` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_11` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_12` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_13` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_14` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_15` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_16` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_17` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_18` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_19` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_20` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_21` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_22` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_23` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_24` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_25` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_26` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_27` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_28` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_29` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_30` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_closure_31` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `object_id` binary(16) NOT NULL COMMENT '节点objectId',
  `ancestor_id` binary(16) NOT NULL COMMENT '祖先objectId',
  `distance` smallint(6) unsigned NOT NULL COMMENT '和祖先的距离，0代表是自己，1代表是祖先的直接子对象',
...
CREATE TABLE IF NOT EXISTS `metadata_router` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `object_id` binary(16) NOT NULL COMMENT '对象id，文档库、版本、文件或者目录',
  `table_no` smallint(6) unsigned NOT NULL COMMENT '表的编号，从0开始',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uk_object_id` (`object_id`),
  KEY `idx_table_no` (`table_no`)
) ENGINE=InnoDB COMMENT='元数据分表路由表';

CREATE TABLE IF NOT EXISTS `metadata_closure_lock` (
  `id` bigint(20) NOT NULL,
  `doc_id` text NOT NULL COMMENT '操作对象路径',
  `operation` tinyint(4) NOT NULL COMMENT '操作类型。1: 移动，2：上传',
  `expire_at` bigint(16) NOT NULL COMMENT '锁过期时间',
  `thread_id` char(32) NOT NULL COMMENT '线程ID',
  `status` tinyint(4) NOT NULL COMMENT '删除标记，0：正常，1：删除',
  PRIMARY KEY (`id`),
  KEY `idx_lock_doc_id` (`doc_id`(768)),
  KEY `idx_thread_id`(`thread_id`),
  KEY `idx_status_expire_at` (`status`,`expire_at`),
  KEY `idx_operation` (`operation`)
 ) ENGINE=InnoDB COMMENT='闭包分布式锁表';

CREATE TABLE IF NOT EXISTS `auto_increment_sequence` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB COMMENT='自增序列号表';

CREATE TABLE IF NOT EXISTS `option` (                           -- 此表保存文档相关配置信息
    `key` varchar(40) NOT NULL,                                 -- 配置关键字
    `value` varchar(1024) NOT NULL,                               -- 配置的值
    PRIMARY KEY (`key`)
) ENGINE=InnoDB;

INSERT INTO `option`(`key`,`value`) SELECT 'doc_csf_level_enum','[{"value":5,"name":"公开"},{"value":6,"name":"普通"},{"value":7,"name":"受控"},{"value":8,"name":"内部"}]' FROM DUAL WHERE NOT EXISTS(SELECT `value` FROM `option` WHERE `key` = 'doc_csf_level_enum');

-- 旧的系统密级暂时保留，后续删除
INSERT INTO `option`(`key`,`value`) SELECT 'sys_csf_level','5' FROM DUAL WHERE NOT EXISTS(SELECT `value` FROM `option` WHERE `key` = 'sys_csf_level');

INSERT INTO `option`(`key`, `value`) SELECT 'add_doclib_lock', 'locked' FROM DUAL WHERE NOT EXISTS (SELECT `value` FROM `option` WHERE `key` = 'add_doclib_lock');

INSERT INTO `option`(`key`,`value`) SELECT 'sys_csf_levels','[5]' FROM DUAL WHERE NOT EXISTS(SELECT `value` FROM `option` WHERE `key` = 'sys_csf_levels');

INSERT INTO `option`(`key`,`value`) SELECT 'doc_csf_level_enum_initialized','false' FROM DUAL WHERE NOT EXISTS(SELECT `value` FROM `option` WHERE `key` = 'doc_csf_level_enum_initialized');

CREATE TABLE IF NOT EXISTS `quarantined_records` (              -- 此表保存被隔离的文档记录
    `objectId` char(40) NOT NULL,                               -- 对象id
    `versionId` char(40) NOT NULL,                              -- 版本id
    `type` int(11) NOT NULL,                                    -- 类型
    `appealStatus` int(11) NOT NULL DEFAULT '0',                -- 申诉状态
    `quarantined` bigint(20) NOT NULL,                          -- 隔离标识
    `fileName` varchar(2048) NOT NULL,                          -- 文件名
    `versionName` varchar(2048) NOT NULL,                       -- 版本名
    `creator` char(40) NOT NULL,                                -- 创建者
    `created` bigint(20) NOT NULL,                              -- 创建时间, 微秒的时间戳
    `modifier` char(40) NOT NULL,                               -- 修改者
    `modified` bigint(20) NOT NULL,                             -- 修改时间, 微秒的时间戳
    `appellant` char(40) DEFAULT NULL,                          -- 申诉人
    `appealReason` text,                                        -- 申述原因
    `parentPath` text NOT NULL,                                 -- 父路径
    `docid` text NOT NULL,                                      -- 文档路径标识
    `reason` text,                                              -- 隔离原因
    `appealSuggest` varchar(2048) DEFAULT NULL,                 -- 申诉处理意见
    `quarantineStatus` int(11) NOT NULL DEFAULT '1',            -- 文件隔离状态
    `restoreParentGns` text,                                    -- 文件还原之后的父路经
    `updateStatusTime` bigint(20) NOT NULL,                     -- 文件隔离状态的更新时间
    PRIMARY KEY (`versionId`),
    KEY `docid` (`docid`(40)) USING BTREE
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `network_segment` (                  -- 此表保存限制访问文档的网段
    `index` bigint(20) unsigned NOT NULL AUTO_INCREMENT,        -- 自增主键
    `ip` varchar(40) NOT NULL DEFAULT '',                       -- IP
    `netmask` varchar(40) NOT NULL DEFAULT '',                  -- 掩码
    `prefixLength` int(11) NOT NULL DEFAULT '0',                -- 网络前缀长度
    `startIP` varchar(40) NOT NULL DEFAULT '',                  -- 起始IP
    `endIP` varchar(40) NOT NULL DEFAULT '',                    -- 终止IP
    `ipVersion` tinyint(4) NOT NULL DEFAULT '4',                -- IP版本标识，4: IPv4  6: IPv6
    `netSegmentType` tinyint(4) NOT NULL DEFAULT '1',           -- 网段的组合类型。1: ip/netmask 2: ip/prefiex 3: startIP/endIP
    PRIMARY KEY (`index`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `limit_suffix_doc` (                 -- 此表保存限制操作的文档类型
  `f_suffix_type` smallint(6) NOT NULL,                         -- 后缀分类
  `f_suffixes` text,                                            -- 后缀的值
  `f_deny_flag` tinyint(4) DEFAULT NULL,                        -- 是否禁止访问
  PRIMARY KEY (`f_suffix_type`)
) ENGINE=InnoDB;

-- gns:// 对象插入老表，用以补全 docId 前缀，新表中无需插入，代码中会直接增加 gns:// 前缀来转换 docId，
-- 而老的表结构需要再额外查一次 AADBD76594AD455995BEB60C19DC157D 的名称，没有必要，增加额外的开销
-- 老的表：文档库的 parentId 是 gns:// （AADBD76594AD455995BEB60C19DC157D），gns:// 对象的 parentId 是全 0
-- 新分表：文档库的 parentId 是 全 0
INSERT INTO `metadata`
(`parentId`, `objectId`, `name`, `custom_metadata`)
SELECT
...
FROM DUAL
WHERE NOT EXISTS (SELECT `objectId` FROM `metadata` WHERE `parentId` = '00000000000000000000000000000000');

-- 隔离区对象插入老表
INSERT INTO `metadata` (`parentId`, `objectId`, `name`)
SELECT 'AADBD76594AD455995BEB60C19DC157D','9855124D1B60466F98308C30951F2C49', 'quarantine'
FROM DUAL WHERE NOT EXISTS (SELECT `objectId` FROM `metadata` WHERE `objectId` = '9855124D1B60466F98308C30951F2C49');

-- 隔离区对象插入表0
INSERT INTO `metadata_0` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_0` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_0` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_0` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表1
INSERT INTO `metadata_1` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_1` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_1` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_1` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表2
INSERT INTO `metadata_2` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_2` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_2` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_2` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表3
INSERT INTO `metadata_3` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_3` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_3` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_3` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表4
INSERT INTO `metadata_4` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_4` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_4` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_4` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表5
INSERT INTO `metadata_5` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_5` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_5` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_5` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表6
INSERT INTO `metadata_6` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_6` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_6` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_6` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表7
INSERT INTO `metadata_7` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_7` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_7` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_7` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表8
INSERT INTO `metadata_8` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_8` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_8` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_8` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表9
INSERT INTO `metadata_9` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_9` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_9` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_9` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表10
INSERT INTO `metadata_10` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_10` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_10` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_10` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表11
INSERT INTO `metadata_11` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_11` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_11` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_11` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表12
INSERT INTO `metadata_12` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_12` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_12` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_12` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表13
INSERT INTO `metadata_13` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_13` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_13` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_13` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表14
INSERT INTO `metadata_14` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_14` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_14` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_14` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表15
INSERT INTO `metadata_15` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_15` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_15` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_15` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表16
INSERT INTO `metadata_16` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_16` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_16` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_16` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表17
INSERT INTO `metadata_17` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_17` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_17` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_17` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表18
INSERT INTO `metadata_18` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_18` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_18` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_18` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表19
INSERT INTO `metadata_19` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_19` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_19` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_19` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表20
INSERT INTO `metadata_20` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_20` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_20` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_20` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表21
INSERT INTO `metadata_21` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_21` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_21` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_21` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表22
INSERT INTO `metadata_22` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_22` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_22` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_22` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表23
INSERT INTO `metadata_23` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_23` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_23` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_23` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表24
INSERT INTO `metadata_24` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_24` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_24` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_24` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表25
INSERT INTO `metadata_25` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_25` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_25` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_25` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表26
INSERT INTO `metadata_26` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_26` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_26` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_26` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表27
INSERT INTO `metadata_27` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_27` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_27` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_27` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表28
INSERT INTO `metadata_28` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_28` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_28` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_28` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表29
INSERT INTO `metadata_29` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_29` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_29` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_29` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表30
INSERT INTO `metadata_30` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_30` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_30` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_30` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

-- 隔离区对象插入表31
INSERT INTO `metadata_31` (`object_id`, `parent_id`, `object_name`, `basic_attr`, `custom_attr`, `creator_id`, `creator_name`,`creator_type`,
`create_time`,`delete_time`,`csf_level`,`custom_metadata`,`system_data`,`status`,`size`,`storage`)
SELECT 0x9855124D1B60466F98308C30951F2C49, 0x00000000000000000000000000000000, 'quarantine', 0,0,0x0,'',0,0,0,5,'','',0,-1,''
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_31` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `metadata_closure_31` (`object_id`, `ancestor_id`, `distance`)
SELECT 0x9855124D1B60466F98308C30951F2C49,0x9855124D1B60466F98308C30951F2C49, 0
FROM DUAL WHERE NOT EXISTS (SELECT `object_id` FROM `metadata_closure_31` WHERE `object_id` = 0x9855124D1B60466F98308C30951F2C49);

INSERT INTO `option` (`key`, `value`) SELECT 'eofs_version', '50331648' FROM DUAL WHERE NOT EXISTS (SELECT `key` FROM `option` WHERE `key` = 'eofs_version');
-- 闭包表开关：全新部署时默认开启
INSERT INTO `option`(`key`, `value`) SELECT 'metadata_closure_enabled','true' FROM DUAL WHERE NOT EXISTS (SELECT `key` FROM `option` WHERE `key` = 'metadata_closure_enabled');
-- 目录异步移动数量限制 for update 使用，value 值无意义
INSERT INTO `option`(`key`, `value`) SELECT 'async_move_lock_key','true' FROM DUAL WHERE NOT EXISTS (SELECT `key` FROM `option` WHERE `key` = 'async_move_lock_key');

-- 自增序列号表初始化
INSERT INTO `auto_increment_sequence` (`key`, `sequence`) SELECT 'metadata_closure_lock', 1 FROM DUAL WHERE NOT EXISTS (SELECT `key`,`sequence` FROM `auto_increment_sequence` WHERE `key` = 'metadata_closure_lock');

INSERT INTO `limit_suffix_doc`
(`f_suffix_type`, `f_suffixes`, `f_deny_flag`)
SELECT
    1,
    '.docx .dotx .dot .doc .odt .wps .docm .dotm .xlsx .et .xlsm .xlsb .xls .xltx .xltm .xlt .xla .pptx .ppt .pot .pps .ppsx .dps .ppam .pptm .potx .potm .ppsm .ppa .pdf .txt .htm .rtf .dic .log .xml .html',
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 1);

INSERT INTO `limit_suffix_doc`
(`f_suffix_type`, `f_suffixes`, `f_deny_flag`)
SELECT
    2,
    '.flv .wmv .mkv .mov .mp4 .asf .mpg .rm .3gp .rmvb .mpeg .mts .m2ts .avi .wif .vob .mp3 .wav .ogg .m4a .flac .ape .aac .wma .wv .mp2 .ac3 .mpc .mka .mpa .dts .mid',
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 2);

INSERT INTO `limit_suffix_doc`
(`f_suffix_type`, `f_suffixes`, `f_deny_flag`)
SELECT
    3,
    '.jpeg .tif .bmp .gif .png .jpg .wmf .emf .raw .ioc .tga .svg',
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 3);

INSERT INTO `limit_suffix_doc`
(`f_suffix_type`, `f_suffixes`, `f_deny_flag`)
SELECT
    4,
    '.zip .rar .tgz .tar .cab .uue .jar .ace .lzh .arj .gzip .gz .gz2 .bz .bz2 .7z .iso .rpm',
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 4);

INSERT INTO `limit_suffix_doc`
(`f_suffix_type`, `f_suffixes`, `f_deny_flag`)
SELECT
    5,
    '.exe .dll .bat .com .cmd .inf .ocx .sys .vn .vbs .vbe .vbx .vxd .js .jse .wsh .wsf .asd .cpl .crt .dbx .hlp .hta .isp .nws .ops .pcd .pi .prf .reg .scf .scr .sct .wab .wsc .pas .mp8 .tbb .sht .mbx .eml .pmr .fpt .inb .adb .cfg .cgi .dhtm .mmf .mht .nch .ods .oft .pl .shtm .stm .uin',
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 5);

INSERT INTO `limit_suffix_doc`
(`f_suffix_type`, `f_suffixes`, `f_deny_flag`)
SELECT
    6,
    '.onion .wallet .wmcry .WNCRY .b01e .locky .Cerber3 .CHAK .GOTHAM .YAYA .GRANNY .SKUNK .TRUE .SEXY .MAKGR .BIG1 .LIN .BIIT .THIRD .DREAM .freeman .BUNNY',
    1
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 6);
...
SELECT
    ...
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `f_suffix_type` FROM `limit_suffix_doc` WHERE `f_suffix_type` = 7);
...
CREATE TABLE IF NOT EXISTS `eft_update_task` (                    -- 此表保存全文检索更新任务
    `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,             -- 自增主键
    `gns` text NOT NULL,                                          -- 文件路径标识
    `isfile` smallint(6) DEFAULT '0',                             -- 是否为文件, 1为文件, 0为目录
    `type` int(11) DEFAULT '0',                                   -- 任务类型
    `extended_attr` varchar(2048) DEFAULT NULL,                   -- 拓展属性
    PRIMARY KEY (`id`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `edocex_task` (                        -- 此表保存文档交换任务
    `f_task_id` bigint(20) NOT NULL AUTO_INCREMENT,               -- 自增主键
    `f_request` text NOT NULL,                                    -- 请求内容
    `f_date` bigint(20) NOT NULL,                                 -- 任务时间, 微秒的时间戳
    PRIMARY KEY (`f_task_id`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `document_statistics` (                -- 此表保存文档统计信息
    `cyclenum` int(11) NOT NULL,                                  -- 统计周期
    `createnum` int(11) DEFAULT '0',                              -- 创建数量
    `modifynum` int(11) DEFAULT '0',                              -- 修改数量
    `deletenum` int(11) DEFAULT '0',                              -- 删除数量
    PRIMARY KEY (`cyclenum`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `operation_statistics` (               -- 此表保存操作统计信息
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,               -- 自增主键
  `cycle_num` int(11) DEFAULT '0',                                -- 统计周期
  `operation_type` int(11) DEFAULT '0',                           -- 操作类型
  `operation_num` int(11) DEFAULT '0',                            -- 操作数量
  PRIMARY KEY (`id`),
  UNIQUE KEY `cycle_operation_index` (`cycle_num`,`operation_type`) USING BTREE
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `other_statistics` (                   -- 此表保存其他文档统计信息
  `cyclenum` int(11) NOT NULL,                                    -- 统计周期
  `createnum` int(11) DEFAULT '0',                                -- 创建数量
  `modifynum` int(11) DEFAULT '0',                                -- 修改数量
  `deletenum` int(11) DEFAULT '0',                                -- 删除数量
...
CREATE TABLE IF NOT EXISTS `picture_statistics` (                 -- 此表保存图片统计信息
  `cyclenum` int(11) NOT NULL,                                    -- 统计周期
  `createnum` int(11) DEFAULT '0',                                -- 创建数量
  `modifynum` int(11) DEFAULT '0',                                -- 修改数量
  `deletenum` int(11) DEFAULT '0',                                -- 删除数量
...
CREATE TABLE IF NOT EXISTS `play_file` (                          -- 此表保存音频转换结果
  `index` bigint(20) unsigned NOT NULL AUTO_INCREMENT,            -- 自增主键
  `file_id` char(40) NOT NULL,                                    -- 转换后文件id
  `file_time` bigint(20) DEFAULT NULL,                            -- 转换完成时间
  `size` bigint(20) DEFAULT '0',                                  -- 转换后文件大小
  `oss_id` char(40) DEFAULT NULL,                                 -- 转换后文件归属存储
  PRIMARY KEY (`index`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `play_seek` (                          -- 此表保存音频转换任务
  `index` bigint(20) unsigned NOT NULL AUTO_INCREMENT,            -- 自增主键
  `manage_id` char(40) NOT NULL,                                  -- 管理对象id
  `version_id` char(40) NOT NULL,                                 -- 版本对象id
  `oss_id` char(40) DEFAULT NULL,                                 -- 版本归属存储
  `od` bigint(20) DEFAULT '-1',                                   -- 转换结果索引
  `sd` bigint(20) DEFAULT '-1',                                   -- 转换结果索引
  `ss` bigint(20) DEFAULT '-1',                                   -- 转换结果索引
  `size` bigint(20) DEFAULT '0',                                  -- 版本大小
  `duration` bigint(20) DEFAULT '0',                              -- 音视频时长
  `status` bigint(20) DEFAULT '0',                                -- 任务状态
  `type` bigint(20) DEFAULT '0',                                  -- 文件类型, 0为视频, 1为音频
  `additional_info` text,                                         -- 转码中产生的信息
  PRIMARY KEY (`index`),
  KEY `f_status_Index` (`status`) USING BTREE,
  KEY idx_versionid (`version_id`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `resources_tags` (                     -- 此表保存资源标签信息
  `objectId` char(40) NOT NULL,                                   -- 对象id
  `parentId` char(40) NOT NULL,                                   -- 父对象id
  `otag` char(40) DEFAULT NULL,                                   -- 资源标签
  `size` bigint(20) DEFAULT '-2',                                 -- 大小
  `time` bigint(20) DEFAULT '-2',                                 -- 时间
  `editorId` char(40) DEFAULT NULL,                               -- 编辑者id
  `editorName` varchar(150) NOT NULL DEFAULT '',                  -- 编辑者名称
  `editorType` tinyint(4) NOT NULL DEFAULT 0,                     -- 编辑者类型
  `client_mtime` bigint(20) DEFAULT '0',                          -- 客户端时间, 微秒的时间戳
  PRIMARY KEY (`objectId`),
  KEY `parentId_Index` (`parentId`) USING HASH,
  KEY `idx_editorId` (`editorId`) USING HASH
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `move_progress_task` (
  `task_id` char(32) NOT NULL,
  `task_type` tinyint(4) NOT NULL COMMENT '任务类型。任务类型。1：移动，2：删除，3: 还原，4：文档库迁移',
  `source` varchar(2048) NOT NULL COMMENT '源路径',
  `destination` varchar(2048) NOT NULL COMMENT '目标路径',
  `overwrite_move` tinyint(2) NOT NULL COMMENT '是否覆盖移动。0: 否，1：是',
  `overwrite_object_id` char(32) NOT NULL COMMENT '移动覆盖的重名对象id',
  `status` tinyint(4) NOT NULL COMMENT '状态。1: 完成，2：失败，3: 等待，4: 移动中',
  `delete_closure_count` bigint(20) NOT NULL COMMENT '删除闭包关系数',
  `insert_closure_count` bigint(20) NOT NULL COMMENT '新增闭包关系数',
  `remain_time_second` bigint(20) NOT NULL COMMENT '预估剩余时间，单位秒',
  `progress_info` text NOT NULL COMMENT '任务进度信息，json格式，供任务中断异常恢复使用',
  `err_info` text NOT NULL COMMENT '错误信息，json格式',
  `create_time` bigint(20) NOT NULL COMMENT '创建时间，微秒精度',
  `modify_time` bigint(20) NOT NULL COMMENT '最后一次任务更新时间，微秒精度',
  `lock_thread_id` varchar(32) NOT NULL COMMENT '闭包表加锁的线程id',
  `retry_count` tinyint(2) NOT NULL COMMENT '当前重试次数',
  PRIMARY KEY (`task_id`),
  KEY `idx_status_modify_time` (`status`,`modify_time`),
  KEY `idx_task_type` (`task_type`),
  KEY `idx_source` (`source`(768)),
  KEY `idx_destination` (`destination`(768))
) ENGINE=InnoDB COMMENT='异步移动任务表';
...
CREATE TABLE IF NOT EXISTS `space_quota` (                        -- 此表保存配额空间信息
  ...
  `space_rate` int(11) NOT NULL DEFAULT 0,                        -- 配额使用率
  PRIMARY KEY (`cid`),
  KEY `idx_quota` (`quota`) USING BTREE,
  KEY `idx_usedsize` (`usedsize`) USING BTREE,
  KEY `idx_space_rate` (`space_rate`) USING BTREE
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `version_data` (                       -- 此表保存文件版本指纹信息
  `data_index` bigint(20) unsigned NOT NULL AUTO_INCREMENT,       -- 自增主键
  `ver_data_id` char(40) NOT NULL,                                -- 管理对象id
  `manage_id` char(40) NOT NULL,                                  -- 版本对象id
  `oss_id` char(40) DEFAULT NULL,                                 -- 数据归属存储
  `timestamp` bigint(16) NOT NULL,                                -- 数据时间戳
  `length` bigint(20) DEFAULT '0',                                -- 数据大小
  `md5` char(40) DEFAULT NULL,                                    -- 数据MD5值
  `crc32` char(10) DEFAULT NULL,                                  -- 数据CRC32
  `slice_md5` char(40) DEFAULT NULL,                              -- 数据切片MD5值
  `status` int(11) DEFAULT '0',                                   -- 任务状态, 0为未开始, 1为进行中, 2为已完成
...
CREATE TABLE IF NOT EXISTS `version_object` (                     -- 此表保存版本映射信息
  `ver_object_id` char(40) NOT NULL,                              -- 版本对象id
  `parent_name` varchar(2048) NOT NULL,                           -- 版本父对象名, 即文件名
  `data_index` bigint(20) unsigned NOT NULL,                      -- 版本索引, version_data表中的一个记录
  CONSTRAINT `version_object_ibfk_1` FOREIGN KEY (`data_index`) REFERENCES `version_data` (`data_index`),
  PRIMARY KEY (`ver_object_id`),
  KEY `data_index` (`data_index`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `video_statistics` (                   -- 此表保存视频统计信息
  `cyclenum` int(11) NOT NULL,                                    -- 统计周期
  `createnum` int(11) DEFAULT '0',                                -- 创建数量
  `modifynum` int(11) DEFAULT '0',                                -- 修改数量
  `deletenum` int(11) DEFAULT '0',                                -- 删除数量
...
CREATE TABLE IF NOT EXISTS `doc_preview` (                        -- 此表保存文档转换任务
  `index` bigint(20) unsigned NOT NULL AUTO_INCREMENT,            -- 自增主键
  `manage_id` char(40) NOT NULL,                                  -- 管理对象id
  `version_id` char(40) NOT NULL,                                 -- 版本对象id
  `version_size` bigint(20) DEFAULT '-1',                         -- 版本大小
  `status` int(11) NOT NULL DEFAULT '0',                          -- 任务状态, 0为未开始, 1为进行中, 2为已完成
  `file_id` char(40),                                             -- 转换后的文件id
  `file_size` bigint(20) DEFAULT '0',                             -- 转换后的文件大小
  `file_time` bigint(20),                                         -- 转换完成时间, 微秒的时间戳
  `oss_id` char(40),                                              -- 数据归属存储
  `ext_name` char(20),                                            -- 文件后缀名
  PRIMARY KEY (`index`),
  UNIQUE KEY index_cidvid (`manage_id`,`version_id`),
  KEY idx_ossid_status (`oss_id`, `status`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `remotetrans` (                        -- 此表保存远程转换任务
  `index` bigint(20) unsigned NOT NULL AUTO_INCREMENT,            -- 自增主键
  `manage_id` char(40) NOT NULL,                                  -- 管理对象id
  `version_id` char(40) NOT NULL,                                 -- 版本对象id
  `version_size` bigint(20) DEFAULT '0',                          -- 版本大小
  `version_type` char(20),                                        -- 版本类型
  `status` int(11) NOT NULL DEFAULT '0',                          -- 任务状态, 0为未开始, 1为进行中, 2为已完成
  `file_id` char(40),                                             -- 转换后的文件id
  `file_size` bigint(20) DEFAULT '0',                             -- 转换后的文件大小
  `file_time` bigint(20),                                         -- 转换完成时间, 微秒的时间戳
  `oss_id` char(40),                                              -- 数据归属存储
  `trans_type` bigint(20),                                        -- 转化类型
  PRIMARY KEY (`index`),
  UNIQUE KEY index_cidvid_transtype (`version_id`,`manage_id`,`trans_type`),
  KEY idx_ossid_status (`oss_id`, `status`)
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `custom_attributes`(                   -- 此表保存自定义属性信息
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,               -- 自增主键
  `name` varchar(128) COLLATE utf8mb4_bin NOT NULL,               -- 属性的名称
  `type` tinyint(4) NOT NULL,                                     -- 属性的类型, 枚举、文本、数值等
  `searchable` tinyint(1) NOT NULL,                               -- 属性是否可以被索引
  `order` int(10) NOT NULL,                                       -- 属性的排序权重
  `status` tinyint(4) NOT NULL DEFAULT '1',                       -- 属性的状态, 是否被禁用
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

CREATE TABLE IF NOT EXISTS `custom_attribute_value`(              -- 此表保存自定义属性值信息
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,               -- 自增主键
  `name` varchar(128) COLLATE utf8mb4_bin NOT NULL,               -- 属性值的名称
  `level` tinyint(4) NOT NULL DEFAULT '1',                        -- 属性值的层级
  `parent_id` bigint(20) NOT NULL,                                -- 属性值的父对象id
  `attribute_id` bigint(20) NOT NULL,                             -- 属性值的属性id
  `status` tinyint(4) NOT NULL DEFAULT '1',                       -- 属性值的状态
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;

CREATE TABLE IF NOT EXISTS `user_access_statistics` (             -- 此表保存用户访问统计信息
  `user_id` char(40) NOT NULL,                                    -- 用户id
  `object_id` char(40) NOT NULL,                                  -- 对象id
  `gns` text NOT NULL,                                            -- 文档路径标识
  `preview_time` bigint(20) DEFAULT '0',                          -- 预览时间, 微秒的时间戳
  PRIMARY KEY (`user_id`, `object_id`),
  KEY `gns_Index` (`gns`(240))
) ENGINE=InnoDB;

CREATE TABLE IF NOT EXISTS `doc_due_date` (                       -- 此表保存文件到期提醒配置信息
  `objectId` char(40) NOT NULL,                                   -- 对象id
  `due_date` bigint(20) DEFAULT '0',                              -- 到期时间
  `create_time` bigint(20) DEFAULT '0',                           -- 创建时间
  `interval` int(10) DEFAULT '1',                                 -- 消息提醒间隔, 单位: 天
  `accessorids` mediumtext,                                       -- 待提醒的对象id, json格式的字符串
  `remindcontent` varchar(4096) DEFAULT NULL,                     -- 消息内容
  PRIMARY KEY (`objectId`)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS `t_outbox` (
  ...
  `f_message` longtext NOT NULL COMMENT '消息内容，json格式字符串',
  `f_create_time` bigint(20) NOT NULL COMMENT '消息创建时间',
  `f_error_time` bigint(20) NOT NULL DEFAULT 0 COMMENT '最近一次消费失败时间',
  PRIMARY KEY (`f_id`),
  KEY `idx_error_time` (`f_error_time`)
) ENGINE=InnoDB COMMENT='outbox信息表';
...
CREATE TABLE IF NOT EXISTS `copy_progress_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `taskId`  char(40) NOT NULL,
  `status`  tinyint(4) NOT NULL DEFAULT 0,
  `fileCount` bigint(20) DEFAULT '0',
  `dirCount` bigint(20) DEFAULT '0',
  `fileCopied` bigint(20) DEFAULT '0',
  `dirCopied` bigint(20) DEFAULT '0',
  `size` bigint(20) DEFAULT '0',
  `sizeCopied` bigint(20) DEFAULT '0',
  `remainTimeSecond` bigint(20) DEFAULT '0',
  `fileScanning` varchar(2048) DEFAULT '',
  `fileCopying` varchar(2048) DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `obj_metadata_apps` (
...
CREATE TABLE IF NOT EXISTS `user_download_statistics`(
  `user_id` char(40) NOT NULL,
  `limit` bigint(20) DEFAULT '-1',
  `times` bigint(20) DEFAULT '0',
  `statistics_timestamp` bigint(20) DEFAULT '0',
  `email_has_been_sent` tinyint(3) DEFAULT '0',
  PRIMARY KEY (`user_id`)
 ) ENGINE=InnoDB;

/* 隔离区 */
INSERT INTO `resources_tags`
(`objectId`, `parentId`, `otag`, `size`, `time`, `editorId`, `editorName`, `editorType`, `client_mtime`)
SELECT
    '9855124D1B60466F98308C30951F2C49',
    'gns',
    ...
    0
FROM DUAL
WHERE NOT EXISTS (SELECT `objectId` FROM `resources_tags` WHERE `objectId` = '9855124D1B60466F98308C30951F2C49');

/* 上传处理记录表 */
CREATE TABLE IF NOT EXISTS `upload_process` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `uploaded_by_id` char(40) NOT NULL COMMENT '上传者ID',
  `uploaded_by_name` char(150) NOT NULL COMMENT '上传者名称',
  `uploaded_by_type` tinyint(4) NOT NULL COMMENT '上传者类型',
  `uploaded_at` bigint(20) NOT NULL COMMENT '上传时间',
  `object_id` char(32) NOT NULL COMMENT '处理对象ID',
  `object_type` tinyint(4) NOT NULL COMMENT '对象类型（1文件夹、2文件）',
  `object_gns` text NOT NULL COMMENT '处理对象gns',
  `operation` tinyint(4) NOT NULL DEFAULT 1 COMMENT '上传时的操作（1新建、2编辑）',
  `process_id` char(18) NOT NULL COMMENT '处理流程ID',
  `process_name` char(150) NOT NULL COMMENT '处理流程名称',
  `process_instance_id` char(18) NOT NULL DEFAULT '' COMMENT '处理流程实例ID',
  `audit_internal_group_id` char(40) NOT NULL DEFAULT '' COMMENT '审核内部组ID',
  `form` text NOT NULL COMMENT '表单信息',
  `perm` text NOT NULL COMMENT '权限信息',
  `initiated_at` bigint(20) NOT NULL DEFAULT 0 COMMENT '发起处理时间，微秒的时间戳',
  `trigger_mode` tinyint(4) NOT NULL DEFAULT 1 COMMENT '触发模式, 1手动触发 2自动触发',
  PRIMARY KEY (`id`),
  KEY `idx_object_id` (`object_id`),
  KEY `idx_object_gns` (`object_gns`(240))
) ENGINE=InnoDB COMMENT='上传处理记录表';

/*上传处理版本记录表*/
CREATE TABLE IF NOT EXISTS `upload_process_version` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增主键',
  `uploaded_at` bigint(20) NOT NULL COMMENT '上传时间',
  `object_id` char(32) NOT NULL COMMENT '处理对象ID',
  `version_id` char(32) NOT NULL DEFAULT '' COMMENT '版本ID',
  PRIMARY KEY (`id`),
  KEY `idx_object_id` (`object_id`),
  KEY `idx_version_id` (`version_id`)
) ENGINE=InnoDB COMMENT='上传处理版本记录表';
