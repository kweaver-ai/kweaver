...
ALTER_TABLE_DICT = [
    ...
    ["dip_data_operator_hub", "t_op_registry",       "COLUMN",   "DROP",   "f_is_latest",   "tinyint(1) DEFAULT 0",         "是否为最新版本"],
    ["dip_data_operator_hub", "t_op_registry",       "COLUMN",   "ADD",    "f_is_internal",  "tinyint(1) DEFAULT 0",        "否为内置算子"]
]
# ！！！以下注释不可删除
# === TEMPLATE START ===
