...
type CreateToolBoxReq struct {
	...
	Category         BizCategory     `json:"box_category" form:"box_category" default:"other_category"`            // 分类
	MetadataType     MetadataType    `json:"metadata_type" form:"metadata_type" validate:"required,oneof=openapi"` // 元数据类型(强制参数)
	Data             json.RawMessage `json:"data" form:"data" validate:"required"`                                 // 元数据
	Source           string          `json:"source" form:"source" default:"custom"`                                // 工具箱来源
}
...
type UpdateToolBoxReq struct {
	...
	BoxSvcURL    string          `json:"box_svc_url" form:"box_svc_url" validate:"required"`                            // 工具箱服务地址
	...
	Data         json.RawMessage `json:"data" form:"data" validate:"omitempty"`                                         // 元数据
}
...
type ToolInfo struct {
	...
	MetadataType     MetadataType           `json:"metadata_type"`                                               // 元数据类型
...
type UpdateToolReq struct {
	...
	ExtendInfo       map[string]interface{} `json:"extend_info" form:"extend_info"`                                        // 扩展信息
	MetadataType     MetadataType           `json:"metadata_type" form:"metadata_type" validate:"omitempty,oneof=openapi"` // 元数据类型(可选参数)
	Data             json.RawMessage        `json:"data" form:"data"`                                                      // 元数据
}
...
type CreateInternalToolBoxReq struct {
	...
	MetadataType     MetadataType    `json:"metadata_type" form:"metadata_type" validate:"required,oneof=openapi"` // 元数据类型
	Data             json.RawMessage `json:"data" form:"data" validate:"required"`                                 // 元数据
