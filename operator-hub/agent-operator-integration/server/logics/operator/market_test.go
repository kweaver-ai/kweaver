...
func TestGetOperatorReleaseByIDPrivate(t *testing.T) {
	...
	operator := &operatorManager{
		...
		DBAPIMetadataManager: mockDBAPIMetadataManager,
		DBTx:                 mockDBTx,
	...
	Convey("TestGetOperatorReleaseByIDPrivate:算子市场查询", t, func() {
