...
(
    ...
    f_quota        tinyint(1) default 0    not null,
    f_default  tinyint(1) default 0    null,
...
(
    ...
    f_create_by    varchar(50)             not null,
    f_update_by    varchar(50)             null,
    f_adapter  tinyint(1) default 0    null,
...
(
    ...
    f_update_by           varchar(50)          null,
    f_update_time         datetime(6)          null,
    f_item_is_delete      tinyint(1) default 0 not null,
    f_type_is_delete      tinyint(1) default 0 not null,
...
(
    ...
    f_is_deploy           tinyint(1) default 0 not null,
    ...
    f_update_by           varchar(50)          null,
    f_update_time         datetime(6)          null,
    f_is_delete           tinyint(1) default 0 not null,
    f_built_in            int default 0        not null,
...
(
    ...
    f_billing_type tinyint not null comment '0 统一计费 ， 1 input output 单独计费',
